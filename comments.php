...
<div id="respond">
	...
	<h2><?php comment_form_title( 'Envie su comentario', 'Enviar su comentario a %s' ); ?></h2>
	...
	<?php if ( get_option('comment_registration') && !is_user_logged_in() ) : ?>
		<p>Debes <a href="<?php echo wp_login_url( get_permalink() ); ?>">registrarte</a> para agregar un comentario.</p>
	<?php else : ?>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<div>
			<input name="submit" type="submit" id="submit" tabindex="5" value="Agregar comentario" />
